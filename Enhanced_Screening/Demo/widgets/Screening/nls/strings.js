...
define({
  root: ({
    ...
    rangeErrorMessage: "The max buffer distance is ${maxValue}", // Shown as alert message if buffer value exceeds maximum value
    clearAOIButtonLabel: "Start Over", // Shown as label for Clear AOI Button
    backButtonLabel: "Back",// Shown to go to AOI Container
    noGraphicsShapefile: "The uploaded shapefile contains no graphics.", // When no graphics is present in the layer
    placenameWidget: {
      placenameLabel: "Define a starting point"
    }, // Shown as label to guide user to enter value in search box
    // Draw Tool widget
    drawToolWidget: {
      useDrawToolForAOILabel: "Select draw mode"
    },
    // Shapefile widget
    shapefileWidget: {
    ...
    coordinatesWidget: {
      ...
      latitudeLabelText: "Latitude", // Shown as label text latitude
      longitudeLabelText: "Longitude", // Shown as label text Longitude
    ...
    bufferDistanceAndUnit: { // Shown as buffer units
      ...
      UNIT_FOOT: "Feet",
      UNIT_METER: "Meters",
      bufferInputTitle: "Buffer distance (required for points and lines)",
    ...
    planSettings: {
      ...
      meters: { label: "Meters", abbreviation: "m" }, // Shown as label for Meters in
      decimalDegree: { label: "Decimal Degree", abbreviation: "dd" }, // Shown as label for Decimal Degree in direction or angle unit dropdown
      degreeMinuteSeconds: { label: "Degree Minute Seconds", abbreviation: "d-m-s" }, // Shown as label for Degree Minute Seconds in direction or angle unit dropdown,
      applyBtnLabel: "Apply",
    ...
    reportsTab: {
      ...
      defaultReportTitle: "Screening Report", //Shown as title for report
      aoiInformationTitle: "Area of Interest (AOI) Information", // Shown as a title for aoi on print preview page
      summaryReportTitle: "Summary of Impact", // Shown as section title for summary report
      summaryReportLayerNameColTitle: "Name", // Shown as col title for layer names in summary report
      summaryReportImpactColTitle: "Impact", // Shown as col title for impact in summary report
      noKnownImpactText: "No known impact", // Shown as text if layer has no impact in summary report
      potentialImpactText: "Potential impact", // Shown as text if layer has potential impact in summary report
    ...
    units: {
      miles: { label: "Miles", abbreviation: "mi" }, // Standard
      kilometer: { label: "Kilometer", abbreviation: "km" }, // Metric
      acres: { label: "Acres", abbreviation: "acres" }, // Standard
      squareKilometer: { label: "Square kilometer", abbreviation: "sq.km." }, // Metric
    }
  }),
  ar: 1,
  fr: 1,
