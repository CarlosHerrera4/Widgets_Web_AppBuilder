  ...
  return declare([BaseWidget, _WidgetsInTemplateMixin, Evented], {
    ...
    updateAccordingToPlanSettings: function (updatedSettings) {
      this.bearingNode.set("placeHolder",
        this.nls.planSettings[updatedSettings.directionOrAngleUnits].abbreviation);
      this.lengthNode.set("placeHolder",
        this.nls.planSettings[updatedSettings.distanceAndLengthUnits].abbreviation);
    },
    ...
    _onZoomButtonClicked: function () {
      if (this.aoiGraphicsLayer.graphics.length > 0) {
        // zoom to AOI
        this._setExtentToLayer(this.aoiGraphicsLayer, true);
      } else {
        // zoom to parcel lines
        this._setExtentToLayer(this.drawnOrSelectedGraphicsLayer, true);
      }
    },
