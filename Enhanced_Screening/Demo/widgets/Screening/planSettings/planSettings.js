...
define([
  ...
  return declare([BaseWidget, Evented], {
    ...
    createPlanSettingsUI: function () {
      ...
      directionUnitsLabel =
      domConstruct.create("div", { "class": "esriCTEllipsis esriCTPlanSettingLabel",
      ...
      distanceUnitLabel =
      domConstruct.create("div", { "class": "esriCTEllipsis esriCTPlanSettingLabel",
      innerHTML: this.nls.planSettings.distanceUnitLabelText }, planSettingsContainer);
      ...
      domConstruct.create("button", {
        "innerHTML": this.nls.planSettings.applyBtnLabel,
