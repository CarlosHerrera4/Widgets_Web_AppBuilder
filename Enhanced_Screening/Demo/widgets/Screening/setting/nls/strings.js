...
define({
  root: ({
    units: { // label shown in config UI dialog box(options for dropdown)
      ...
      decimalDegree: "Decimal Degree", // Shown as label for Decimal Degree in direction or angle unit dropdown
      degreeMinuteSeconds: "Degree Minute Seconds" // Shown as label for Degree Minute Seconds in direction or angle unit dropdown,
    },
    analysisTab: {
      ...
      addLayerLabelTitle: "Label", // shown as title in config UI for add layer label in Add Layer section.
      addLayerActionsTitle: "Actions", // shown as title in config UI for add layer Actions in Add Layer section.
      ...
      addFieldsLabelTitle: "Label", // shown as title in config UI for add Fields Fields in Add Fields section.
      addFieldsNameTitle: "Field Names", // shown as title in config UI for add Fields Name in Add Fields section.
      addFieldsActionsTitle: "Actions", // shown as title in config UI for add Fields Actions in Add Fields section.
    ...
    generalTab: {
      ...
      tabLabelsLegend: "Tab Labels", // shown as label in config UI for Tab Labels Fieldset legend
      tabLabelsHint: "Hint: Specify Labels", // shown as hint in config UI for Tab Labels Fieldset
      AOITabLabel: "Area of Interest Tab", // shown as label in config UI for Tab Labels Fieldset AOI Tab Option
      ReportTabLabel: "Report Tab", // shown as label in config UI for Tab Labels Fieldset Report Tab Option
      ...
      maxBufferDistanceLabel: "Max Buffer Distance", // shown as label in config UI for Buffer Settings Fieldset Max Buffer Distance Option
      maxBufferUnitsLabel: "Max Buffer Units", // shown as label in config UI for Buffer Settings Fieldset Max Buffer Units Option
    ...
    errorMsg: {
      ...
      defaultLessThanMaxBufferDistanceFieldErrorMsg: "Max buffer distance should not be 0 or less than default buffer distance", // Shown as error message if default buffer distance textbox field value less than max buffer distance textbox field.
      ...
      noFieldSelected: "Please use the edit action to select a field", // Shown as error message if no field selected for add layers section
